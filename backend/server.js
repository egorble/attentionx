...
const NETWORKS = {
    rise: {
        ...
        imageBase: "https://attentionx.fun/metadata/images",
    },
};

// Parse --network flag (defaults to rise)
const networkArg = process.argv.find((_, i) => i > 0 && process.argv[i - 1] === "--network") || "rise";
const network = NETWORKS[networkArg] || NETWORKS.rise;
...
function buildMetadata(tokenId, tokenData) {
    ...
    return {
        ...
        image: imageUrl,
        external_url: `https://attentionx.fun/card/${tokenId}`,
