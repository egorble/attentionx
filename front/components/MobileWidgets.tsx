    ...
    return (
        <div className="my-6 xl:hidden">
            ...
            {onOpenPack && (
                <div className="mb-3 rounded-xl overflow-hidden shadow-lg bg-[#0a0a0a] border border-[#1a1a1a]">
                    ...
                    <div className="p-3 border-t border-[#1a1a1a] flex items-center justify-between">
                        ...
                        <button
                            onClick={onOpenPack}
                            className="bg-yc-purple hover:bg-purple-600 text-white px-5 py-2.5 rounded-lg font-black text-sm uppercase tracking-wider active:scale-95 transition-all shadow-md shadow-purple-500/20"
                        >
                            Buy Pack
                        </button>
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                {/* Referral Card */}
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-gray-900 dark:to-black border border-purple-200 dark:border-gray-800 rounded-xl p-4">
                    ...
                    {isConnected && (
                        <div className="flex gap-2 mb-3">
                            <div className="flex-1 bg-white/80 dark:bg-black/50 rounded-lg p-2 border border-purple-200/50 dark:border-gray-700 text-center">
                    ...
                    <div className="relative">
                        <input
                            ...
                            readOnly
                            className="w-full bg-white/80 dark:bg-black/50 border border-purple-200/50 dark:border-gray-700 text-gray-600 dark:text-gray-400 text-[10px] px-3 py-2 pr-14 rounded-lg font-mono focus:outline-none truncate"
                        />
                        <button
                            onClick={handleCopy}
